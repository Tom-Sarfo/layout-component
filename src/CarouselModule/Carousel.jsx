...
export default function Carousel({ slides }) {
  ...
  const CarouselStyle = {
    container:
      "w-96 h-96 bg-white absolute ease-out duration-300 translate-x-1",
    slide: "w-96 h-96 flex justify-center items-center text-3xl",
    prevBtn: "flex justify-between relative top-1/2 px-2",
    slideIndicators: "flex justify-evenly relative bottom-20",
    switchBtn:
